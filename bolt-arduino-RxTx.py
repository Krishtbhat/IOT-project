...
def send_telegram_message(message, imageNum):
    ...
    try:
        ...
        bot.send_photo(chat_id="@alerts_boltIOT19", photo=open('./images/'+ imageNum +'.bmp', 'rb'))
...
https://cloud.boltiot.com/control?name=BOLT3848004"""
        ...
        telegram_status = send_telegram_message(message, imageNum)
